...
def get_quality_settings(quality_preset):
    ...
    presets = {
        'high': {'maxrate': '4500k', 'bufsize': '9000k', 'preset': 'veryfast'}, # 1080p ish
        'medium': {'maxrate': '2500k', 'bufsize': '5000k', 'preset': 'veryfast'}, # 720p
        'low': {'maxrate': '1000k', 'bufsize': '2000k', 'preset': 'superfast'}  # 480p / hemat bandwidth
    }
